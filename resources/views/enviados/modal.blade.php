    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Importar Entregas</h5>
            ...
            <div class="row">
                ...
                <form id="frmImportarEnlaces" class="form-horizontal striped-rows b-form" >
                        <div class="form-group row">
                          <div class="col-md-5">
                              <div>
                                  <label for="alias" class="control-label col-form-label">Adjunte el archivo en formato Excel. Recuerde que la primer fila no será leída y contada como el titulo de la columna</label>
                              </div>
                          </div>
                          <div class="col-md-7">
