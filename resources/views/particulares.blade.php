...
<body>
	...
	<div class="wrapper">
		...
		<form class="multisteps-form__form" action="{{route('sitio.abono_registro')}}" id="wizard" method="POST">
        ...
        $(document).ready(function(){
			...
			$("#dni" ).focusout(function() {	
				...
				if((val != _validate) && val){
					_validate = val;
					$.ajax({
						url: "/sitio/validar/abono/particulares",
						method: 'POST',
						data: {
							documento: val,
						},
