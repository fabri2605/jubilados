...
<div class="col-xs-12 col-lg-12 " style="margin-top:10px; margin-bottom: 10px;">
    <div class="row">
        <button type="button" class="btn btn-success cblanco btn-sm col-lg-1 col-xs-7" onclick="window.location='{{ route('solicitudes_san_rafael.create') }}'">
            <i class="ti-plus"></i>
            Nuevo
        </button>
        &nbsp;
...
<hr>
<div class="col-lg-12">
    <table id="solicitudes_san_rafael-table" class="table no-footer table-reclamos table-striped table-bordered table-hover" role="grid" cellspacing="0" style="width:100%">
      <thead class="bg-info">
        <tr role="row">
  ...
  <script type="text/javascript">
        ...
        $(function () {
            ...
            var table = $('#solicitudes_san_rafael-table').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{{ route('solicitudes_san_rafael.index') }}",
                },
                columns: [
                ...
                $.confirm({
                    ...
                    buttons: {
                        aceptar: {
                            ...
                            action :function () {
                                $.ajax({
                                    url: "solicitudes_san_rafael/eliminar/"+product_id,
                                    method: 'DELETE',
                                }).done(function(data) {
            ...
            $('#btnConsultaReporte').on('click', function(){
                ...
                if(fecha_desde && fecha_hasta ){
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        url: 'solicitudes_san_rafael/generar/reporte/',
                        data: params,
